...
$_LANG['app_name'] = 'LeGouDay';
$_LANG['cp_home'] = '乐购网管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2011-2013 深圳乐购网有限公司，并保留所有权利。';
...
/* 淘宝部分 */
if (file_exists(ROOT_PATH . 'includes/modules/taobao/lang/' . $_CFG['lang'] . '/admin/common.php'))
{
    include_once(ROOT_PATH . 'includes/modules/taobao/lang/' . $_CFG['lang'] . '/admin/common.php');
}
