...
/* 淘宝部分 */
if (file_exists(ROOT_PATH . 'includes/modules/taobao/admin/priv_action.php'))
{
    include_once(ROOT_PATH . 'includes/modules/taobao/admin/priv_action.php');
}
