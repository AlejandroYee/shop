...
class integrate
{
    ...
    function add_user($username, $password, $email, $tuijianren, $gender = -1, $bday = 0, $reg_date=0, $md5password='')
    {//echo $tuijianren; exit;
        /* 将用户添加到整合方 */
		...
		$post_tuijianren = $tuijianren;
		
		//echo $post_tuijianren; exit;
        ...
        $fields = array($this->field_name, $this->field_email, $this->field_pass, tuijianren);
        $values = array($post_username, $email, $post_password, $post_tuijianren);
