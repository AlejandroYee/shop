...
#menu-div li {
  float: left;
  border-right: 1px solid #015094;
  border-left:1px solid #2787da;
}
...
#submenu-div a.fix-submenu{clear:both; margin-left:5px; padding:1px 5px; *padding:3px 5px 5px; background:#fff; color:#f00; border:#005cac 1px solid}
#submenu-div a.fix-submenu:hover{padding:1px 5px; *padding:3px 5px 5px; background:#005cac; color:#fff; border:#005cac 1px solid}
...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="images/legou_logo.gif" alt="Design By Levinchiu" /></div>
