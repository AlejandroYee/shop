...
<div class="mbt10 main" id="pgoods">
  <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=34">酒具大全</a> <code>&gt;</code> 高级酒具五件套装</div>  
  <div id="csb">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div id="cma">
   ...
   <div id="goodsinfo" class="mbt10">
     ...
     <div id="imginfo">
<a href="images/201301/goods_img/328_P_1357607346711.jpg" ID="zoom1" rel="thumb-change: mouseover;" class="MagicZoom MagicThumb" title="高级酒具五件套装" >
<img src="images/201301/goods_img/328_G_1357607346351.jpg" alt="高级酒具五件套装" width="300"/>
</a>
 ...
 <div class="clearfix">
      ...
      <div class="gallery">
        <div id="demo" class="clearfix">
          <div id="demo1" style="float:left">
            <ul class="clearfix">
                         <li style="float:left;"><a  href="images/201301/goods_img/328_P_1357607346711.jpg" rel="zoom1" rev="images/201301/goods_img/328_P_1357607346711.jpg" title=""><img src="images/201301/thumb_img/328_thumb_P_1357607346155.jpg" alt="高级酒具五件套装" /></a>
            </li>
                        </ul>
          </div>
     ...
     <form action="javascript:addToCart(328)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <ul>
         ...
         <li class="clearfix">
       <dd>
              <strong>商品货号：</strong>LG000328              </dd>
       <dd class="ddR">
                         <strong>商品库存：</strong>
          1000                      </dd>
      </li>
      ...
      <li class="clearfix">
       ...
       <strong>商品点击数：</strong>120       </dd>
      </li>
                          <li class="clearfix">
       <strong>购买此商品可使用：</strong><font class="f4">200 </font>
      </li>
                   <li id="buy">
           <p class="mbt10"><span>购买数量        <input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" class="text tnum"/></span>
                 </p>
 <a href="javascript:addToCart(328)"><img src="themes/LevinJiu/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(328)"><img src="themes/LevinJiu/images/bnt_colles.gif" /></a>
      </li>
     ...
     <div class="tt">
      ...
      <div id="com_h">
       <blockquote>
        <p><img alt="" width="675" height="204" src="/images/upload/Image/1357550054(6).jpg" /></p>
<p><span style="font-size: medium">产品介绍</span></p>
<div class="bodyzone">
<p><span style="font-size: medium">【品 名】高级酒具五件套装<br />
【型 号】SW-WB07<br />
【品 牌】SUNWAY</span></p>
<p><span style="font-size: medium">本套装产品包括：</span></p>
<p><span style="font-size: medium">瓶口切箔器、杠杆塔式开瓶器、真空保鲜瓶塞、迷型快速醒酒器</span></p>
<p><span style="font-size: medium">包装新颖独特、典雅高贵、美观时尚,是您送礼、馈赠的首选佳品。</span></p>
<p><span style="font-size: medium">包装规格：34 x 24 x 10 (cm)</span></p>
...
<div><span style="font-size: 9pt">作为中国酒具行业的第一品牌，尚为一直在技术研发、产品创新等方面引领这一行业的发展。拥有多项国内及国际专利，从中国制造到中国创造，尚为让中国创造迈出国门，走向世界，并以专业品质赢得了全球消费者的认可与信赖。所有产品均已通过CE、ROHS、FDA、LFGB等国际相关产品质量认证以及符合相关的国内质量检测标准。而卓越的品质也正是尚为酒具畅销海内外的坚实后盾，尚为公司是国内首家取得ISO9001质量管理体系认证的酒具制造企业。</span></div>
...
<form name="tagForm" action="javascript:;" onSubmit="return submitTag(this)" id="tagForm">
        ...
        <p>
          ...
          <input type="hidden" name="goods_id" value="328"  />
        </p>
                <script type="text/javascript">
                //<![CDATA[
...
<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:328;}554fcae493e564ee0dc75bdf2ebf94ca</div>
  </div>
