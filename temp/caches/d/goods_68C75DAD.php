...
<title>天赋鸿运 金柔顺30年_白酒_按种类分_乐购网-购物快乐每一天  www.legouday.com - Powered by ECShop</title>
...
<div class="mbt10 main" id="pgoods">
  <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">按种类分</a> <code>&gt;</code> <a href="category.php?id=2">白酒</a> <code>&gt;</code> 天赋鸿运 金柔顺30年</div>  
  <div id="csb">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div id="cma">
   ...
   <div id="goodsinfo" class="mbt10">
     ...
     <div id="imginfo">
<a href="images/201211/goods_img/121_P_1353050781026.jpg" ID="zoom1" rel="thumb-change: mouseover;" class="MagicZoom MagicThumb" title="天赋鸿运 金柔顺30年" >
<img src="images/201211/goods_img/121_G_1353050743294.jpg" alt="天赋鸿运 金柔顺30年" width="300"/>
</a>
 ...
 <div class="clearfix">
      ...
      <div class="gallery">
        <div id="demo" class="clearfix">
          <div id="demo1" style="float:left">
            <ul class="clearfix">
                         <li style="float:left;"><a  href="images/201211/goods_img/121_P_1353050781026.jpg" rel="zoom1" rev="images/201211/goods_img/121_P_1353050781026.jpg" title=""><img src="images/201211/thumb_img/121_thumb_P_1353050781961.jpg" alt="天赋鸿运 金柔顺30年" /></a>
            </li>
                        </ul>
          </div>
     ...
     <form action="javascript:addToCart(121)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <li class="clearfix">
       <dd>
             <strong>上架时间：</strong>2012-11-04             </dd>
       <dd class="ddR">
       
       <strong>商品点击数：</strong>158       </dd>
      </li>
                                <li id="buy">
           <p class="mbt10"><span>购买数量        <input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" class="text tnum"/></span>
                 </p>
 <a href="javascript:addToCart(121)"><img src="themes/LevinJiu/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(121)"><img src="themes/LevinJiu/images/bnt_colles.gif" /></a>
      </li>
...
<p><img alt="" style="width: 701px; height: 325px" src="/images/upload/Image/G_4.jpg" /></p>
<p><img alt="" style="width: 694px; height: 327px" src="/images/upload/Image/G_5.jpg" /></p>
