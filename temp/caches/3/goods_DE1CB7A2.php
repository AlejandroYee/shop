...
<title>天赋鸿运 金碧辉映_白酒_按种类分_乐购网-购物快乐每一天  www.legouday.com - Powered by ECShop</title>
...
<div class="mbt10 main" id="pgoods">
  <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">按种类分</a> <code>&gt;</code> <a href="category.php?id=2">白酒</a> <code>&gt;</code> 天赋鸿运 金碧辉映</div>  
  <div id="csb">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div id="cma">
   ...
   <div id="goodsinfo" class="mbt10">
     ...
     <div id="imginfo">
<a href="images/201211/goods_img/115_P_1353050779938.jpg" ID="zoom1" rel="thumb-change: mouseover;" class="MagicZoom MagicThumb" title="天赋鸿运 金碧辉映" >
<img src="images/201211/goods_img/115_G_1353050741425.jpg" alt="天赋鸿运 金碧辉映" width="300"/>
</a>
 ...
 <div class="clearfix">
      ...
      <div class="gallery">
        <div id="demo" class="clearfix">
          <div id="demo1" style="float:left">
            <ul class="clearfix">
                         <li style="float:left;"><a  href="images/201211/goods_img/115_P_1353050779938.jpg" rel="zoom1" rev="images/201211/goods_img/115_P_1353050779938.jpg" title=""><img src="images/201211/thumb_img/115_thumb_P_1353050779966.jpg" alt="天赋鸿运 金碧辉映" /></a>
            </li>
                        <li style="float:left;"><a  href="images/201211/goods_img/115_P_1353050779216.jpg" rel="zoom1" rev="images/201211/goods_img/115_P_1353050779216.jpg" title=""><img src="images/201211/thumb_img/115_thumb_P_1353050779022.jpg" alt="天赋鸿运 金碧辉映" /></a>
            </li>
                        <li style="float:left;"><a  href="images/201211/goods_img/115_P_1353050779556.jpg" rel="zoom1" rev="images/201211/goods_img/115_P_1353050779556.jpg" title=""><img src="images/201211/thumb_img/115_thumb_P_1353050779040.jpg" alt="天赋鸿运 金碧辉映" /></a>
            </li>
                        </ul>
          </div>
     ...
     <form action="javascript:addToCart(115)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <li class="clearfix">
       ...
       <strong>商品点击数：</strong>201       </dd>
      </li>
                                <li id="buy">
           <p class="mbt10"><span>购买数量        <input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" class="text tnum"/></span>
                 </p>
 <a href="javascript:addToCart(115)"><img src="themes/LevinJiu/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(115)"><img src="themes/LevinJiu/images/bnt_colles.gif" /></a>
      </li>
...
<p><img alt="" style="width: 696px; height: 501px" src="/images/upload/Image/1_6(2).jpg" /></p>
<p><img alt="" style="width: 689px; height: 478px" src="/images/upload/Image/1_4(1).jpg" /></p>
<p><img alt="" style="width: 695px; height: 987px" src="/images/upload/Image/11_17(13).jpg" /></p>       </blockquote>
     <blockquote>
...
<form name="tagForm" action="javascript:;" onSubmit="return submitTag(this)" id="tagForm">
        ...
        <p>
          ...
          <input type="hidden" name="goods_id" value="115"  />
        </p>
                <script type="text/javascript">
                //<![CDATA[
