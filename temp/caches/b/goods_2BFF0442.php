...
<title>青云郎 50年 998ml_白酒_按种类分_乐购网-购物快乐每一天  www.legouday.com - Powered by ECShop</title>
...
<div class="mbt10 main" id="pgoods">
  <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">按种类分</a> <code>&gt;</code> <a href="category.php?id=2">白酒</a> <code>&gt;</code> 青云郎 50年 998ml</div>  
  <div id="csb">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div id="cma">
   ...
   <div id="goodsinfo" class="mbt10">
     ...
     <div id="imginfo">
<a href="images/201211/goods_img/199_P_1353550084340.jpg" ID="zoom1" rel="thumb-change: mouseover;" class="MagicZoom MagicThumb" title="青云郎 50年 998ml" >
<img src="images/201211/goods_img/199_G_1353550084214.jpg" alt="青云郎 50年 998ml" width="300"/>
</a>
 ...
 <div class="clearfix">
      ...
      <div class="gallery">
        <div id="demo" class="clearfix">
          <div id="demo1" style="float:left">
            <ul class="clearfix">
                         <li style="float:left;"><a  href="images/201211/goods_img/199_P_1353550084340.jpg" rel="zoom1" rev="images/201211/goods_img/199_P_1353550084340.jpg" title=""><img src="images/201211/thumb_img/199_thumb_P_1353550084525.jpg" alt="青云郎 50年 998ml" /></a>
            </li>
                        </ul>
          </div>
     ...
     <form action="javascript:addToCart(199)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <li class="clearfix">
       ...
       <strong>商品点击数：</strong>296       </dd>
      </li>
                                <li id="buy">
           <p class="mbt10"><span>购买数量        <input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" class="text tnum"/></span>
                 </p>
 <a href="javascript:addToCart(199)"><img src="themes/LevinJiu/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(199)"><img src="themes/LevinJiu/images/bnt_colles.gif" /></a>
      </li>
...
<p><img alt="" width="675" height="268" src="/images/upload/Image/k1.jpg" /></p>
<p><img width="675" height="800" alt="" src="/images/upload/Image/ol.jpg" /></p>
<p><img alt="" src="/images/upload/Image/aaq(1).jpg" /></p>       </blockquote>
     <blockquote>
