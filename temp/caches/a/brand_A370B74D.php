...
<title>科隆贝_乐购网-购物快乐每一天  www.legouday.com - Powered by ECShop</title>
...
<div class="main mbt10" id="pbrand">
  <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> 科隆贝</div>  
  <div id="csb">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div id="cma">
  <div class="nmb">
<div class="tt"><h3>科隆贝</h3><span></span></div>
<div class="ct">
<div class="p1-0 bgw">
        ...
        <tr>
          ...
          <br />
            ...
            <div class="brandCategoryA">
                          <a href="brand.php?id=53" class="f6">所有分类 </a>
                          <a href="brand.php?id=53&amp;cat=12" class="f6">法国 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
  ...
  <div id="show_best_area" class="ct"><div class="bgw p1-0">
      <div class="gmg left" id="rec_01">
         <span class="best"></span>
           <a href="goods.php?id=275"><img src="images/201212/thumb_img/275_thumb_G_1354396012088.jpg" alt="科隆贝2009VDP美乐干红" class="gi" /></a>
           <a class="gn" href="goods.php?id=275" title="科隆贝2009VDP美乐干红">科隆贝2009VDP美乐干红</a>
           <p class="gp">
           <span class="market_price">市场价格：<b> ￥169元</b></span><br/>
           <span class="shop_price">本店售价：<b> ￥169元</b></span>
           </p>
        </div>
    <div class="clear"></div>
    </div></div>
...
<div id="categorylistnav">
  ...
  <a href="brand.php?category=0&display=grid&brand=53&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/LevinJiu/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="brand.php?category=0&display=grid&brand=53&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/LevinJiu/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="brand.php?category=0&display=grid&brand=53&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/LevinJiu/images/last_update_default.gif" alt="按更新时间排序"></a>
...
<div class="bgw p1-0">
                        <div class="gmg">
    <a href="goods.php?id=275"><img src="images/201212/thumb_img/275_thumb_G_1354396012088.jpg" alt="科隆贝2009VDP美乐干红" class="gi" /></a>
    <a href="goods.php?id=275" class="gn">科隆贝2009VDP美乐干红</a>
           <p class="gp">
           <span class="market_price">市场价格：<b> ￥169元</b></span><br/>
           <span class="shop_price">本店售价：<b> ￥169元</b></span>
           </p>
 <div id="action">         <a href="javascript:collect(275);" class="gf">收藏</a><a href="javascript:addToCart(275)" class="gct">购买</a><a href="javascript:;" id="compareLink" onClick="Compare.add(275,'科隆贝2009VDP美乐干红','')" class="gcp">比较</a>
 <div class="clear"></div>
</div> 
    </div>
                        <div class="clear"></div>
...
<div class="blank"></div>
 ...
 北辰        Tel: 400-9900-949        E-mail: service@legouday.com<br />
   ...
   <!-- <div align="left"  id="rss" style="text-align:center"><a href="feed.php?brand=53"><img src="themes/LevinJiu/images/xml_rss2.gif" alt="rss" /></a></div>-->
 </div>
</div></div>
</body>
</html>
