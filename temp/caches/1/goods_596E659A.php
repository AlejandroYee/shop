...
<div class="mbt10 main" id="pgoods">
  <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=40">茶具大全</a> <code>&gt;</code> <a href="category.php?id=41">陶瓷茶具</a> <code>&gt;</code> 雪浮珠单杯</div>  
  <div id="csb">
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div id="cma">
   ...
   <div id="goodsinfo" class="mbt10">
     ...
     <div id="imginfo">
<a href="images/201211/goods_img/254_P_1354230838216.jpg" ID="zoom1" rel="thumb-change: mouseover;" class="MagicZoom MagicThumb" title="雪浮珠单杯" >
<img src="images/201211/goods_img/254_G_1354230838239.jpg" alt="雪浮珠单杯" width="300"/>
</a>
 ...
 <div class="clearfix">
      ...
      <div class="gallery">
        <div id="demo" class="clearfix">
          <div id="demo1" style="float:left">
            <ul class="clearfix">
                         <li style="float:left;"><a  href="images/201211/goods_img/254_P_1354230838216.jpg" rel="zoom1" rev="images/201211/goods_img/254_P_1354230838216.jpg" title=""><img src="images/201211/thumb_img/254_thumb_P_1354230838244.jpg" alt="雪浮珠单杯" /></a>
            </li>
                        </ul>
          </div>
     ...
     <form action="javascript:addToCart(254)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <li class="clearfix">
       ...
       <strong>商品点击数：</strong>75       </dd>
      </li>
                          <li class="clearfix">
       <strong>购买此商品可使用：</strong><font class="f4">100 </font>
      </li>
                   <li id="buy">
           <p class="mbt10"><span>购买数量        <input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" class="text tnum"/></span>
                 </p>
 <a href="javascript:addToCart(254)"><img src="themes/LevinJiu/images/bnt_cat.gif" /></a>
      <a href="javascript:collect(254)"><img src="themes/LevinJiu/images/bnt_colles.gif" /></a>
      </li>
